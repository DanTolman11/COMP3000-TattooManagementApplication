...
public class StockPanel extends JPanel {
    ...
    private JTextField txtStockCategory;
        ...
        lstStock.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (lstStock.getSelectedIndex() != -1){
                    ...
                    txtStockId.setText(String.valueOf(currentlyEditing.getId()));
                    txtStockName.setText(currentlyEditing.getName());
                    txtStockAmount.setText(String.valueOf(currentlyEditing.getAmount()));
                    txtStockCategory.setText(currentlyEditing.getCategory());
                }
            }
        });
